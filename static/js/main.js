...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (btnPrintReport) {
        btnPrintReport.addEventListener('click', () => {
            ...
            document.getElementById('repReportId').textContent = reportId;
            document.getElementById('repReportIdFooter').textContent = reportId;
            document.getElementById('repDate').textContent = currentDate;
            document.getElementById('repDateFooter').textContent = currentDate;
            document.getElementById('repTime').textContent = currentTime;
            document.getElementById('repTimeFooter').textContent = currentTime;
            
            // Scan Info
            document.getElementById('repScanId').textContent = document.getElementById('lblPatientId').textContent || "PAT-8472-X";
            document.getElementById('repImgName').textContent = document.getElementById('lblActiveFile').textContent || "PET_Scan_01.png";
            
            let formatText = document.getElementById('lblModality').textContent || "PNG Image";
            if (formatText.includes("--") || formatText === "") {
                formatText = "PNG Image";
            }
            document.getElementById('repFormat').textContent = formatText;
            document.getElementById('repResolution').textContent = "200 x 200 px";
            
            let doseText = document.getElementById('lblEstimatedDose').textContent || "10x Dose Reduction";
            if (doseText.includes("--") || doseText === "") {
                doseText = "10x Dose Reduction";
            }
            document.getElementById('repDoseFactor').textContent = doseText;
            document.getElementById('repProcTime').textContent = "1.24 seconds";
            
            // Images
            document.getElementById('repInputImg').src = document.getElementById('inputPreview').src;
            document.getElementById('repOutputImg').src = document.getElementById('outputPreview').src;
            
            // Metrics
            document.getElementById('repInputPsnr').textContent = document.getElementById('lblInputPsnr').textContent;
            document.getElementById('repEnhancedPsnr').textContent = document.getElementById('lblEnhancedPsnr').textContent;
            document.getElementById('repPsnrImprovement').textContent = document.getElementById('lblPsnrImprovement').textContent;
            
            document.getElementById('repInputSsim').textContent = document.getElementById('lblInputSsim').textContent;
            document.getElementById('repEnhancedSsim').textContent = document.getElementById('lblEnhancedSsim').textContent;
            document.getElementById('repSsimImprovement').textContent = document.getElementById('lblSsimImprovement').textContent;
            
            document.getElementById('repInputRmse').textContent = document.getElementById('lblInputRmse').textContent;
            document.getElementById('repEnhancedRmse').textContent = document.getElementById('lblEnhancedRmse').textContent;
            document.getElementById('repRmseImprovement').textContent = document.getElementById('lblRmseImprovement').textContent;
            
            document.getElementById('repInputNrmse').textContent = document.getElementById('lblInputNrmse').textContent;
